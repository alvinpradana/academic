...
Route::middleware('auth')->group(function() {
    ...
    Route::get('/scores/academic-year-{academic}', [ScoreController::class, 'listOfClass'])->name('scores.list-of-class');
    Route::get('/scores/academic-year-{academic}/class-{class}', [ScoreController::class, 'semesters'])->name('scores.semesters');
    Route::get('/scores/academic-year-{academic}/class-{class}/semester-{semester}/list-of-task', [ScoreController::class, 'taskOrFinalTask'])->name('scores.list-of-task');
    Route::get('/scores/academic-year-{academic}/class-{class}/semester-{semester}/final-task', [ScoreController::class, 'listFinalTask'])->name('scores.list-of-final-task');
    Route::get('/scores/academic-year-{academic}/class-{class}/semester-{semester}/final-task/lesson-{lesson}', [ScoreController::class, 'finalTaskTable'])->name('scores.final-task-table');
