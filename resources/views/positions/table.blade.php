<div class="d-flex justify-content-between align-items-center mb-4">
    <p class="my-auto">Tabel berikut merupakan data jabatan/posisi pada SMA N 9 MUKOMUKO.</p>
                                ...
                                <td>
                                    @if ($position->id > 3)
                                        ...
                                        @component('components.modal')
                                            ...
                                            @endslot
                                        @endcomponent
                                        <button type="button" class="btn btn-danger btn-sm btn-circle" data-toggle="modal" data-target="#modal_{{ $position->id }}">
                                            <i class="fas fa-trash"></i>
                                        </button>
                                    @endif
                                </td>
