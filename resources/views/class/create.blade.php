                            ...
                            <div class="mb-3">
                                ...
                                <select id="class-major" class="form-select form-control @error('major') is-invalid @enderror" name="major">
                                    ...
                                    @foreach ($majors as $major)
                                        <option {{ old('major') == $major->id ? "selected" : "" }} value="{{ $major->id }}">{{ $major->title }}</option>
                                    @endforeach
                                </select>
                                @error('major')
                                    <span class="invalid-feedback">{{ $message }}</span>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="class-grade" class="form-select form-control @error('grade') is-invalid @enderror" name="grade">
                                    ...
                                    @foreach ($grades as $grade)
                                        <option {{ old('grade') == $grade->id ? "selected" : "" }} value="{{ $grade->id }}">{{ $grade->title }}</option>
                                    @endforeach
                                </select>
                                @error('grade')
                                    <span class="invalid-feedback">{{ $message }}</span>
                            ...
                            <div class="mb-3">
                                ...
                                <select id="teacher-class" class="form-select form-control @error('teacher') is-invalid @enderror" name="teacher">
                                    ...
                                    @foreach ($teachers as $teacher)
                                        <option {{ old('teacher') == $teacher->id ? "selected" : "" }} value="{{ $teacher->id }}">{{ $teacher->user_complements->name }}</option>
                                    @endforeach
                                </select>
                                @error('teacher')
                                    <span class="invalid-feedback">{{ $message }}</span>
